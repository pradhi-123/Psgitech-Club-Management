...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-blue-100 via-indigo-100 via-purple-100 to-amber-100 flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans text-slate-900">
      ...
      <Button 
        variant="ghost" 
        onClick={() => navigate("/")}
        className="absolute top-6 left-6 text-slate-500 hover:text-slate-800 hover:bg-slate-200/50 gap-1 text-sm font-semibold z-10 transition-all"
      >
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="username" className="text-slate-700 font-semibold flex items-center gap-1.5 text-xs sm:text-sm">
              ...
              <Input
                ...
                className="bg-white border-slate-200 text-slate-800 placeholder-slate-400 focus:border-primary focus:ring-primary/20 h-11 rounded-xl transition-all"
                required
              />
            </div>
            ...
            {/* Password Field */}
            <div className="space-y-2">
              <Label htmlFor="password" className="text-slate-700 font-semibold flex items-center gap-1.5 text-xs sm:text-sm">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-white border-slate-200 text-slate-800 placeholder-slate-400 focus:border-primary focus:ring-primary/20 pr-10 h-11 rounded-xl transition-all"
                  required
                />
                <button
                  type="button"
            ...
            <Button 
              type="submit" 
              className="w-full bg-gradient-primary text-white font-bold py-5 rounded-xl shadow-lg shadow-primary/20 hover:scale-[1.01] transition-all duration-200 mt-4 text-base" 
              disabled={loading}
            >
